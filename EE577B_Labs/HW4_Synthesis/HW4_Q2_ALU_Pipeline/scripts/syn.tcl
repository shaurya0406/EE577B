...
analyze -format verilog ./src/div_unsigned.v
set_dont_touch div_unsigned
elaborate div_unsigned
...
# Create a clock with period of 20.
create_clock -name clk -period 40.0 -waveform [list 0 20] [get_ports clk]
